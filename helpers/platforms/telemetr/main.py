...
from helpers.platforms.telemetr.check_red_line_history import check_red_line_history
...
def check_channel_in_telemetr(driver, channel_name, result_out_path):
    if is_telemetr_check:
        ...
        # проверка на историю красных меток
        check_red_line_history(driver=driver, result_out_path=result_out_path)
